...
class EngagementServiceTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_if_it_create()
    {
        ...
        // Prepare ..
        $data                = ['type' => 'pompier', 'materiel' => 1, 'intervention' => 2015, 'pompier' => 2, 'etat' => 'En cours'];
        ...
        try {
            $service->save(['type' => 'alo',  'materiel' => 1, 'intervention' => 2015, 'pompier' => 2]);
